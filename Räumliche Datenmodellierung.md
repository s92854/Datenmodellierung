...
Das Rasterbild, das verwendet wird, besitzt eine Genauigkeit von 25 Metern, aber es zeigt Unterschiede im Vergleich zur tatsächlichen Geländebeschaffenheit. Insbesondere in großen, nahezu ebenen Gebieten sind diese Unterschiede viel offensichtlicher im Vergleich zu Regionen mit abwechslungsreicherem Gelände. Bei ebenen Flächen sind die Neigungswinkel der Geländeformationen nur minimal verschieden von benachbarten Bereichen. Deshalb gestaltet sich die Vorhersage des genauen Verlaufs als äußerst ungenau. Bei landwirtschaftlichen Flächen beispielsweise entsteht eher eine Wasserfläche als ein eindeutiges Flussmuster. Zusätzlich können natürliche Elemente wie Bäume oder strukturelle Merkmale, die möglicherweise nicht im Rasterbild erfasst wurden, den Verlauf erheblich beeinflussen oder umlenken. Manchmal unterstützen sie ihn sogar, wie beispielsweise asphaltierte Straßen oder landwirtschaftliche Flächen. Faktoren wie Verdunstung, Bodenbeschaffenheit und die Versickerung wurden in dieser Analyse nicht berücksichtigt. Gleiches gilt für regionale Unterschiede im Niederschlagsmuster.
